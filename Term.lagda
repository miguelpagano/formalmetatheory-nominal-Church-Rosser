...
∣ ƛ a M ∣  =  1 + ∣ M ∣
--
sizePositive : {M : Λ} → ∣ M ∣ > zero
sizePositive {v x}    = s≤s z≤n
sizePositive {M · N}
  = start
      suc zero
    ≤⟨ sizePositive {M} ⟩
...
lemma∣va∣ {M · N}  |MN|≤1   = ⊥-elim (>1→¬≤1 {∣ M ∣ + ∣ N ∣} (lemmam>0∧n>0→m+n>1 {∣ M ∣} {∣ N ∣} (sizePositive {M}) (sizePositive  {N})) (≤′⇒≤ |MN|≤1))
lemma∣va∣ {ƛ a M}  |ƛaM|≤1  = ⊥-elim (>1→¬≤1 {1 + ∣ M ∣} (lemmam>0∧n>0→m+n>1 {1} {∣ M ∣} (s≤s z≤n) (sizePositive {M})) (≤′⇒≤ |ƛaM|≤1))
--
...
lemmaΛ-atoms {a} {v b}    a∉[b]
  with b ≟ₐ a
... | no b≢a    = ∉v b≢a
lemmaΛ-atoms {a} {v .a}    a∉[a]
    | yes refl  = ⊥-elim (a∉[a] (here refl))
lemmaΛ-atoms {a} {M · N} a∉Λ-atomsM++Λ-atomsN with ∉-++⁻ (Λ-atoms M) a∉Λ-atomsM++Λ-atomsN
... | a∉Λ-atomsM , a∉Λ-atomsN
  = ∉· (lemmaΛ-atoms a∉Λ-atomsM) (lemmaΛ-atoms a∉Λ-atomsN)
lemmaΛ-atoms {a} {ƛ b M}  a∉b∷Λ-atomsM
  with b ≟ₐ a
... | no b≢a    = ∉ƛ b≢a (lemmaΛ-atoms (a∉b∷Λ-atomsM ∘ there))
lemmaΛ-atoms {a} {ƛ .a M}  a∉b∷Λ-atomsM
    | yes refl  = ⊥-elim (a∉b∷Λ-atomsM (here refl))
--
_#?_ : Decidable _#_
x #? (v y) with y ≟ₐ x
...
lemmafvfree→ x (ƛ y M)  x∈fvM-y with ∈-filter⁻ ((λ z → ¬? (y ≟ₐ z))) {xs = fv M} x∈fvM-y
... | p , y≢x = *ƛ (lemmafvfree→ x M p) y≢x
--
...
lemma*swap← {a} {b} {.a} {ƛ c M} (*ƛ a*（bc）M b≢a) | .b
  ...
  | inj₂ (inj₂ (a≠b , refl  , b*M)) = inj₂ (inj₂ (a≠b , (refl , (*ƛ b*M c≠b))))
